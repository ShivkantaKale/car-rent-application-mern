...
import { deleteCarbooking } from "../redux/actions/bookingActions";
            ...
            {bookings.filter(o=>o.user==user._id).map((booking) => {
             return <Row gutter={16} className="bs1 mt-3 text-left">
                ...
                <Col lg={6} sm={24} className='text-right'>
                    ...
                    <Popconfirm
              title="Are you sure to Cancel this car Booking?"
              onConfirm={()=>{dispatch(deleteCarbooking({bookingid : booking._id}))}}
              
              okText="Yes"
              cancelText="No"
            >
              <DeleteOutlined
                style={{tabSize:"20px", color: "red", cursor: "pointer" }}
              />
            </Popconfirm> 
